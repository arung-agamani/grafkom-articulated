...
async function main() {
    ...
    gl.enable(gl.FRAGMENT_SHADER_DERIVATIVE_HINT);
    ...
    glObject1.setMode(2)
    glObject1.setTexture("cubetexture.png")
    glObject1.setNormalMap("bump_normal.png")

    icosphere.setX(50)
    icosphere.setY(50)
    icosphere.setZ(50)
    const glObject2 = icosphere.getObject(2, shaderProgram, gl)
    glObject2.setAnchorPoint(glObject1.getPoint(1), 3)
    glObject2.setPosition(0,icosphere.y/2,-icosphere.z)
    ...
    glObject2.setMode(2)
    glObject2.setTexture("cubetexture.png")
    glObject2.setNormalMap("bump_normal.png")

    icosphere.setX(icosphere.x/0.9)
    icosphere.setY(icosphere.y/0.9)
    icosphere.setZ(icosphere.z/0.9)
    const glObject3 = icosphere.getObject(3, shaderProgram, gl)
    glObject3.setAnchorPoint(glObject2.getPoint(1), 3)
    glObject3.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject3.setMode(2)
    glObject3.setTexture("cubetexture.png")
    glObject3.setNormalMap("bump_normal.png")
    
    const glObject4 = icosphere.getObject(4, shaderProgram, gl)
    glObject4.setAnchorPoint(glObject3.getPoint(1), 3)
    glObject4.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject4.setMode(2)
    glObject4.setTexture("cubetexture.png")
    glObject4.setNormalMap("bump_normal.png")

    const glObject5 = icosphere.getObject(5, shaderProgram, gl)
    glObject5.setAnchorPoint(glObject4.getPoint(1), 3)
    glObject5.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject5.setMode(2)
    glObject5.setTexture("cubetexture.png")
    glObject5.setNormalMap("bump_normal.png")

    const glObject6 = icosphere.getObject(6, shaderProgram, gl)
    glObject6.setAnchorPoint(glObject5.getPoint(1), 3)
    glObject6.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject6.setMode(2)
    glObject6.setTexture("cubetexture.png")
    glObject6.setNormalMap("bump_normal.png")

    const glObject7 = icosphere.getObject(7, shaderProgram, gl)
    glObject7.setAnchorPoint(glObject6.getPoint(1), 3)
    glObject7.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject7.setMode(2)
    glObject7.setTexture("cubetexture.png")
    glObject7.setNormalMap("bump_normal.png")

    const glObject8 = icosphere.getObject(8, shaderProgram, gl)
    glObject8.setAnchorPoint(glObject7.getPoint(1), 3)
    glObject8.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject8.setMode(2)
    glObject8.setTexture("cubetexture.png")
    glObject8.setNormalMap("bump_normal.png")

    const glObject9 = icosphere.getObject(9, shaderProgram, gl)
    glObject9.setAnchorPoint(glObject8.getPoint(1), 3)
    glObject9.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject9.setMode(2)
    glObject9.setTexture("cubetexture.png")
    glObject9.setNormalMap("bump_normal.png")

    const glObject10 = icosphere.getObject(10, shaderProgram, gl)
    glObject10.setAnchorPoint(glObject9.getPoint(1), 3)
    glObject10.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject10.setMode(2)
    glObject10.setTexture("cubetexture.png")
    glObject10.setNormalMap("bump_normal.png")

    const glObject11 = icosphere.getObject(11, shaderProgram, gl)
    glObject11.setAnchorPoint(glObject10.getPoint(1), 3)
    glObject11.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject11.setMode(2)
    glObject11.setTexture("cubetexture.png")
    glObject11.setNormalMap("bump_normal.png")

    const glObject12 = icosphere.getObject(12, shaderProgram, gl)
    glObject12.setAnchorPoint(glObject11.getPoint(1), 3)
    glObject12.setPosition(0,icosphere.y/2,-icosphere.z/2)
    ...
    glObject12.setMode(2)
    glObject12.setTexture("cubetexture.png")
    glObject12.setNormalMap("bump_normal.png")
    ...
    glObject13.setMode(2)
    glObject13.setTexture("cubetexture.png")
    glObject13.setNormalMap("bump_normal.png")
